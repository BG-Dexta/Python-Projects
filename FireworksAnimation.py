...
def main():
    ...
    launchers = [Launcher(100, HEIGHT - Launcher.HEIGHT, random.randint(1, 6) * 1000),
                 Launcher(300, HEIGHT - Launcher.HEIGHT, random.randint(1, 6) * 1000),
                 Launcher(500, HEIGHT - Launcher.HEIGHT, random.randint(1, 6) * 1000),
                 Launcher(700, HEIGHT - Launcher.HEIGHT, random.randint(1, 6) * 1000)]
